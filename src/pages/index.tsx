      ...
      <Section grayish>
        ...
        <Col3>
          ...
          <Feature title="교육지원금" icon={<MdPaid style={{ color: "#202c3c", fontSize: "36px" }} />}>
            <p>교육 지원금을 제공하여 비용 걱정 없이 학습에만 집중할 수 있도록 최선의 지원을 아끼지 않습니다 (금액 미정)</p>
          </Feature>
          <Feature title="교통" icon={<MdDirectionsBus style={{ color: "#202c3c", fontSize: "36px" }} />}>
            <p>판교 교육장까지의 거리가 먼 경우를 위해 무료 셔틀버스 운행을 운행 (예정, 변경가능)</p>
          </Feature>
          ...
          <Feature title="인턴/서류면제" icon={<MdBadge style={{ color: "#202c3c", fontSize: "36px" }} />}>
            <p>수료 성적 상위 10% SK, MDS 등 기업 채용형 인턴 확정, 수료인원에 한해서는 서류 면제 협의중.</p>
          </Feature>
        </Col3>
      </Section>
      <Section>
